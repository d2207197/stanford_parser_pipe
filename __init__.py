...
command = 'java -mx1024m -cp "%s": edu.stanford.nlp.parser.lexparser.LexicalizedParser -sentences newline -tokenized -escaper edu.stanford.nlp.process.PTBEscapingProcessor -outputFormat wordsAndTags,penn,typedDependencies -outputFormatOptions basicDependencies "%s" -' % (parser_path, model_path)
